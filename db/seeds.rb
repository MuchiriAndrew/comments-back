...
# User.find_by(id: 6)&.update(password: '1234567')
# User.find_by(id: 7)&.update(password: 'qwerqwer', password_confirmation: 'qwerqwer')
User.find_by(id: 8)&.update(password: 'abcdefg')
# User.find_by(id: 4)&.update(password: '987654321', password_confirmation: '987654321')